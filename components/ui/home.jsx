...
const Home = () => {
  return (
    <section className='min-h-screen flex flex-col items-start pt-1 max-w-7xl mx-auto p-8 lg:px-36 relative overflow-hidden'>
        <RightSocials/>
        <LeftScroll to='#skills'/>
        <p className="text-teal-400 text-xl font-mono text-lg mb-4 pt-12">Hello, my name is</p>

        <h1 className="text-7xl lg:text-8xl font-bold text-white mb-2">
            Charan Vardham.
        </h1>
        <h2 className="text-5xl lg:text-6xl font-bold text-gray-400 mb-10 leading-tight">
    ...
    <div className="p-6 bg-neutral-900 border border-neutral-700 rounded-xl hover:border-teal-400 transition-colors group">
        ...
        <Link 
            ...
            className="mt-6 flex items-center gap-2 text-gray-500 hover:text-teal-400 transition-colors font-mono text-sm group pl-2">
